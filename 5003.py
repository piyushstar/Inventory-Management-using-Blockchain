...
MYSQL_DATABASE_NAME = "CustomerData3"
MYSQL_TABLE_NAME = "CustomerData3.dbo"
...
class BlockChain:
    ...
    def add_transaction(self,sender,receiver,amount):
        ...
        cursor.execute("SELECT * from CustomerData3.dbo")
...
def mine_block():
    ...
    blockchain.add_transaction(sender = node_address, receiver = 'Warehouse', amount = 12)
